...
def odczytDanychZKanalu(galaz, nrKanalu, zbocze):
    ...
    kanal.append(galaz.GetLeaf("FTAB_Rising").GetValue())
    kanal.append(galaz.GetLeaf("FTAB_Channel").GetValue())
    kanal.append(galaz.GetLeaf("FTAB_Coarse").GetValue())
    kanal.append(galaz.GetLeaf("FTAB_Fine").GetValue())
    return kanal#rozlozPomiarNaSkladowe(kanal)
